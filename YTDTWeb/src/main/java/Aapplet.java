        ...
        implements Runnable
{
    ...
    public void pingpong(String str, String portName, String deviceNum)
    {
    ...
    public void outputToLed(String str, String portName, String deviceNum)
    {
        beginOperation(portName);
    ...
    public void myInitialize(String portName)
    {
