 ...
 public class InbenhnhanlanhthuocBHYT
   implements Serializable
 {
   ...
   {
     this.reportTypeKC = "Inbenhnhanlanhthuoc";
     this.log.info("Vao Method XuatReport In benh nhan lanh thuoc BHYT", new Object[0]);
     String baocao1 = null;
     try
     {
       ...
       this.log.info("thuoc ma so " + this.thuoc_maso, new Object[0]);
       if (this.thuoc_maso != null) {
         params.put("THUOCMASO", this.thuoc_maso);
       }
       ...
       baocao1 = XuatReportUtil.ReportUtil(this.jasperPrintKC, index, IConstantsRes.PATH_BASE + IConstantsRes.PATH_REPORT_RESULT_DIEU_TRI + "duocpham/", "pdf", "Inbenhnhanlanhthuoc");
 ...
 * Qualified Name:     com.iesvn.yte.dieutri.duocpham.action.InbenhnhanlanhthuocBHYT
