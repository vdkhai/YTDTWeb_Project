 ...
 public class Inthongtinchitietmotmathang
   implements Serializable
 {
   ...
   {
     this.reportTypeKC = "Inthongtinchitiet1mathang";
     this.log.info("Vao Method XuatReport In thong tin chi tiet mot mat hang", new Object[0]);
     String baocao1 = null;
     try
     {
       ...
       baocao1 = XuatReportUtil.ReportUtil(this.jasperPrintKC, index, IConstantsRes.PATH_BASE + IConstantsRes.PATH_REPORT_RESULT_DIEU_TRI + "duocpham/", "pdf", "Inthongtinchitiet1mathang");
 ...
 * Qualified Name:     com.iesvn.yte.dieutri.duocpham.action.Inthongtinchitietmotmathang
