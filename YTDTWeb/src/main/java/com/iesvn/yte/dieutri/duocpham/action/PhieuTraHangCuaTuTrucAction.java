 ...
 public class PhieuTraHangCuaTuTrucAction
   implements Serializable
 {
   ...
   public String init(String loaikho)
   {
     ...
     this.dmKhoaNhan = ((DmKhoa)dieuTriUtilDelegate.findByMa(this.maKho, "DmKhoa", "dmkhoaMa"));
   ...
   private void resetValue()
   {
     ...
     this.nofound = "false";
     this.listCtTraKhoB4165 = new ArrayList();
   ...
   public void displayPhieuDuTru()
   {
     ...
     PhieuTraKho ptkho = ptkDel.findByPhieuDuTruMa(this.phieuDuTru.getPhieudtMa(), this.dmKhoaNhan.getDmkhoaMaso());
     if (ptkho != null)
     {
       this.phieuTraKho = ptkho;
       SetInforUtil.setInforIfNullForPhieuTraKho(this.phieuTraKho);
       this.ngayXuat = new SimpleDateFormat("dd/MM/yyyy").format(this.phieuTraKho.getPhieutrakhoNgay());
       List<CtTraKho> listCtTraKho = cttkDel.findByphieutrakhoMa(this.phieuTraKho.getPhieutrakhoMa());
       for (CtTraKho obj : listCtTraKho)
       {
         GridItem ct = new GridItem();
         ct.setCtTraKho(obj);
         this.listCtTraKhoB4165.add(ct);
       }
     ...
     PhieuDuTru objPhieuDuTru = CtPhieuDtDelegate.getInstance().findByPhieuDuTruPhanBietKho(this.phieuDuTru.getPhieudtMa(), Integer.valueOf(3), this.dmKhoaNhan.getDmkhoaMaso());
     ...
     List<CtPhieuDt> objCtPhieuDt = CtPhieuDtDelegate.getInstance().findByPhieuDuTruMa(this.phieuDuTru.getPhieudtMa());
     this.phieuDuTru = objPhieuDuTru;
     this.dmLoaiTen = this.phieuDuTru.getDmloaithuocMaso().getDmloaithuocTen();
     SetInforUtil.setInforIfNullForPhieuTraKho(this.phieuTraKho);
     this.phieuTraKho.setPhieutrakhoLoaiPhieu(this.phieuDuTru.getPhieudtLoaiPhieu());
     this.phieuTraKho.setDmloaithuocMaso(this.phieuDuTru.getDmloaithuocMaso());
     ...
     for (CtPhieuDt ctpdt : objCtPhieuDt)
     {
       ...
       this.listCtTraKhoB4165.add(new GridItem(cttk, ctpdt.getCtdtSoluong()));
       log.info("***** ctpdt.getCtdtTra() " + ctpdt.getCtdtTra());
       log.info("***** ctpdt.getCtdtSoluong() " + ctpdt.getCtdtSoluong());
     }
     log.info("-----listCtTraKhoB4165: " + this.listCtTraKhoB4165.size());
   ...
   {
     log.info("---delete");
     this.listCtTraKhoB4165.remove(this.selCtTraKhoB4113);
     this.ctTraKhoB4113 = new GridItem();
   }
   ...
   public void enter()
   {
     ...
     if (this.isUpdate) {
       ...
       this.listCtTraKhoB4165.add(this.ctTraKhoB4113);
     }
     tinhTongTien();
     this.ctTraKhoB4113 = new GridItem();
   }
   ...
   private void tinhTongTien()
   {
     ...
     if (this.listCtTraKhoB4165 != null) {
       for (GridItem obj : this.listCtTraKhoB4165)
       {
     ...
     throws Exception
   {
     ...
     if ((this.phieuDuTru.getPhieudtMa() == null) || (this.phieuDuTru.getPhieudtMa().equals("")) || (this.listCtTraKhoB4165 == null) || (this.listCtTraKhoB4165.size() == 0) || (this.phieuTraKho.getPhieutrakhoThanhtien().doubleValue() == 0.0D))
     {
       this.nosuccess = "true";
     ...
     else
     {
       ...
       log.info("***** DmkhoaTra " + this.phieuDuTru.getPhieudtMakho());
       log.info("***** DmkhoanNhan " + this.phieuDuTru.getDmkhoaMaso());
       this.phieuTraKho.setDmkhoaTra(this.phieuDuTru.getPhieudtMakho());
       this.phieuTraKho.setDmkhoaNhan(this.phieuDuTru.getDmkhoaMaso());
       for (GridItem item : this.listCtTraKhoB4165)
       {
       ...
       String result = PhieuTraKhoDelegate.getInstance().updatePhieuDTTuTrucTraKho(listTraKho, this.phieuTraKho, IConstantsRes.PRIORITY_TON_LO_THUOC);
       ...
       else if (result.indexOf(".") > 0)
       {
         ...
         FacesMessages.instance().add(IConstantsRes.PHIEU_DU_TRU_KHONGDUTHUOCTRA, new Object[] { maThuoc, soluongTon });
         this.hienThiGhiNhan = "";
         this.hienThiInPhieu = "";
       }
       else
     ...
     throws Exception
   {
     ...
     if ((maPhieuTra != null) && (!maPhieuTra.equals("")))
     {
       ...
       PhieuTraKho ptk_tmp = delegate.findByPhieutrakhoByKhoNhan(maPhieuTra, this.dmKhoaNhan.getDmkhoaMaso());
       if (ptk_tmp != null)
       {
   ...
   public TonKho createTonKhoNhan(CtTraKho ct)
   {
     ...
     tk.setDtdmnhanvienCn(this.phieuTraKho.getDtdmnhanvienCn());
   ...
   public PhieuTraHangCuaTuTrucAction()
   {
     this.hienThiGhiNhan = "";
     this.hienThiInPhieu = "";
   ...
   {
     this.reportTypeKC = "phieutrahangcuatutruc";
 ...
 * Qualified Name:     com.iesvn.yte.dieutri.duocpham.action.PhieuTraHangCuaTuTrucAction
