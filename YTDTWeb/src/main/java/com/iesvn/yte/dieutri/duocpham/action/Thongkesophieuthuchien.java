 ...
 public class Thongkesophieuthuchien
   implements Serializable
 {
   ...
   {
     this.reportTypeKC = "TKsophieuthuchien";
     this.log.info("Vao Method XuatReport thong ke so phieu thuc hien", new Object[0]);
     String baocao1 = null;
     try
     {
       ...
       baocao1 = XuatReportUtil.ReportUtil(this.jasperPrintKC, index, IConstantsRes.PATH_BASE + IConstantsRes.PATH_REPORT_RESULT_DIEU_TRI + "duocpham/", "pdf", "TKsophieuthuchien");
 ...
 * Qualified Name:     com.iesvn.yte.dieutri.duocpham.action.Thongkesophieuthuchien
