 ...
 public class XuatHangTheoPhieuDuTruAction
   implements Serializable
 {
   ...
   private static Logger log = Logger.getLogger(XuatHangTheoPhieuDuTruAction.class);
   ...
   @DataModel
   private List<CtXuatKho> listCtxk = new ArrayList();
   @DataModelSelection
   ...
   private void updateRow()
   {
     ...
     int i = this.listCtxk.indexOf(this.nhapctSelected_B4122);
     if (i < 0) {
       insertRow();
     }
     log.info("****i=" + i + "******");
     this.listCtxk.set(i, this.nhapctSelected_B4122);
     Caculation(this.listCtxk);
     ...
     throws Exception
   {
     ...
     log.info("listCtxk.indexOf(nhapctSelected):" + this.listCtxk.indexOf(this.nhapctSelected_B4122));

     this.listCtxk.remove(index);
     Caculation(this.listCtxk);
     resetValue();
     this.updateNhapct = false;
     this.maFinish = "";
     ...
     throws Exception
   {
     ...
     for (CtXuatKho ctxk : this.listCtxk) {
     ...
     this.maFinish = pxkWS.XuatPhieuDuTru(this.listCtxk, this.phieuXuatKho, IConstantsRes.PRIORITY_TON_LO_THUOC);
     ...
     if ((this.maFinish != null) && (!this.maFinish.equals("")))
     {
       ...
       else if (this.maFinish.indexOf("ERROR") >= 0)
       {
         FacesMessages.instance().add(this.maFinish, new Object[0]);
         this.hienThiGhiNhan = Boolean.valueOf(false);
         this.hienThiInPhieu = Boolean.valueOf(false);
     ...
     throws Exception
   {
     ...
     this.listCtxk = ctxkDel.findByphieuxuatkhoMa(this.maPhieuXuat);
     Caculation(this.listCtxk);
     ...
     throws Exception
   {
     try
     {
       ...
       PhieuXuatKhoDelegate pxkDel = PhieuXuatKhoDelegate.getInstance();
       CtXuatKhoDelegate ctxkDel = CtXuatKhoDelegate.getInstance();
       PhieuXuatKho pxkho = pxkDel.findByPhieuDuTruAndKhoXuat(this.maPhieuDuTru, this.dmkhoaXuat.getDmkhoaMaso());
       if (pxkho != null)
       {
         this.phieuXuatKho = pxkho;
         SetInforUtil.setInforIfNullForPhieuXuatKho(this.phieuXuatKho);
         setMaPhieuXuat(this.phieuXuatKho.getPhieuxuatkhoMa());
         setMaPhieuDuTru(this.phieuXuatKho.getPhieudtMa().getPhieudtMa());
         this.dmLoaiTen = this.phieuXuatKho.getDmloaithuocMaso().getDmloaithuocTen();
         SimpleDateFormat frmtDate = new SimpleDateFormat("dd/MM/yyyy");
         setNgayXuat(frmtDate.format(this.phieuXuatKho.getPhieuxuatkhoNgaylap()));
         this.listCtxk = ctxkDel.findByphieuxuatkhoMa(this.phieuXuatKho.getPhieuxuatkhoMa());
         Caculation(this.listCtxk);
         this.maFinish = this.phieuXuatKho.getPhieuxuatkhoMa();
       ...
       phieuDt = ctpdtWS.findByPhieuDuTruKhoXuatPhanBiet(this.maPhieuDuTru, Integer.valueOf(0), this.dmkhoaXuat.getDmkhoaMaso());
       ...
       boolean daXuatThuoc = ctPhieuDtDel.daXuatThuocTheoPhieuDT_New(this.maPhieuDuTru);
       if (daXuatThuoc == true)
       {
         FacesMessages.instance().add(IConstantsRes.PHIEU_DU_TRU_DA_XUAT_HANG, new Object[] { this.maPhieuDuTru });
         this.hienThiGhiNhan = Boolean.valueOf(false);
   ...
   {
     this.reportTypeKC = "B4122_XuatHangTheoPhieuDuTru";
 ...
 * Qualified Name:     com.iesvn.yte.dieutri.duocpham.action.XuatHangTheoPhieuDuTruAction
