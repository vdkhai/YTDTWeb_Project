 ...
 public class B271_DanhSachNguoiBenhRaVaoVien
   implements Serializable
 {
   ...
   {
     this.loaiBCDT = "DSNguoiBenhVaoRaVien";
     this.log.info("Vao Method XuatReport DS nguoi benh vao ra vienn", new Object[0]);
     String baocao1 = null;
     ...
     try
     {
       ...
       baocao1 = XuatReportUtil.ReportUtil(this.jasperPrintDT, this.index, IConstantsRes.PATH_BASE + IConstantsRes.PATH_REPORT_RESULT_DIEU_TRI + "hsba/", "pdf", "DSNguoiBenhRaVaoVien");
 ...
 * Qualified Name:     com.iesvn.yte.dieutri.hsba.action.B271_DanhSachNguoiBenhRaVaoVien
