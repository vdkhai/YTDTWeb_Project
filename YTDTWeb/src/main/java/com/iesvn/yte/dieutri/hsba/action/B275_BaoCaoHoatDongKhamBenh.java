 ...
 public class B275_BaoCaoHoatDongKhamBenh
   implements Serializable
 {
   ...
   {
     this.loaiBCDT = "BCHoatDongKhamBenh";
     this.log.info("Vao Method XuatReport In danh sach B275_BaoCaoHoatDongKhamBenh", new Object[0]);
     String baocao1 = null;
     ...
     try
     {
       ...
       baocao1 = XuatReportUtil.ReportUtil(this.jasperPrintTD, this.index, IConstantsRes.PATH_BASE + IConstantsRes.PATH_REPORT_RESULT_DIEU_TRI + "hsba/", "pdf", "hoatdongkhambenh");
 ...
 * Qualified Name:     com.iesvn.yte.dieutri.hsba.action.B275_BaoCaoHoatDongKhamBenh
