 ...
 public class B295_BaoCaoDuocBenhVien
   implements Serializable
 {
   ...
   {
     this.loaiBCDT = "BCDuocBenhVien";
     this.log.info("Vao Method XuatReport duoc benh vien", new Object[0]);
     String baocao1 = null;
     ...
     try
     {
       ...
       if (this.tieude.trim().equals("")) {
         params.put("tieude", IConstantsRes.BAO_CAO_THONG_KE + " " + IConstantsRes.TU + " " + this.tungay + " " + IConstantsRes.DEN + " " + this.denngay);
       } else {
       ...
       baocao1 = XuatReportUtil.ReportUtil(this.jasperPrintDT, index, IConstantsRes.PATH_BASE + IConstantsRes.PATH_REPORT_RESULT_DIEU_TRI + "hsba/", "pdf", "duocbenhvien");
 ...
 * Qualified Name:     com.iesvn.yte.dieutri.hsba.action.B295_BaoCaoDuocBenhVien
