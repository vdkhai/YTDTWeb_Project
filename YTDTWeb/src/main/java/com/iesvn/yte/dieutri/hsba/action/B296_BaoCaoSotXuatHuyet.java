 ...
 public class B296_BaoCaoSotXuatHuyet
   implements Serializable
 {
   ...
   {
     this.loaiBCDT = "BCSotXuatHuyet";
     this.log.info("Vao Method XuatReport sot xuat huyet", new Object[0]);
     ...
     try
     {
       ...
       pathTemplate = IConstantsRes.PATH_BASE + IConstantsRes.PATH_REPORT_TEMPLATE_DIEU_TRI + "hsba/sotxuathuyet_sub" + this.loaiBaoCao + ".jrxml";
       ...
       baocao1 = XuatReportUtil.ReportUtil(this.jasperPrintDT, index, IConstantsRes.PATH_BASE + IConstantsRes.PATH_REPORT_RESULT_DIEU_TRI + "hsba/", "pdf", "Sotxuathuyet");
 ...
 * Qualified Name:     com.iesvn.yte.dieutri.hsba.action.B296_BaoCaoSotXuatHuyet
