 ...
 public class B297_BieuMauBanTuDong1
   implements Serializable
 {
   ...
   {
     this.loaiBCDT = "BieuMauBanTuDong1";
     ...
     try
     {
       ...
       baocao1 = XuatReportUtil.ReportUtil(this.jasperPrintDT, this.index, IConstantsRes.PATH_BASE + IConstantsRes.PATH_REPORT_RESULT_DIEU_TRI + "hsba/", "pdf", "BieuMauBanTuDong1");
 ...
 * Qualified Name:     com.iesvn.yte.dieutri.hsba.action.B297_BieuMauBanTuDong1
