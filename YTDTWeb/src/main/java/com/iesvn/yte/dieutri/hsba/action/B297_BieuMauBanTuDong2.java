 ...
 public class B297_BieuMauBanTuDong2
   implements Serializable
 {
   ...
   {
     this.loaiBCDT = "BieuMauBanTuDong2";
     ...
     try
     {
       ...
       baocao1 = XuatReportUtil.ReportUtil(this.jasperPrintDT, this.index, IConstantsRes.PATH_BASE + IConstantsRes.PATH_REPORT_RESULT_DIEU_TRI + "hsba/", "pdf", "BieuMauBanTuDong2");
 ...
 * Qualified Name:     com.iesvn.yte.dieutri.hsba.action.B297_BieuMauBanTuDong2
