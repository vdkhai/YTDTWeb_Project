 ...
 public class B297_BieuMauBanTuDong3
   implements Serializable
 {
   ...
   {
     this.loaiBCDT = "BieuMauBanTuDong3";
     ...
     try
     {
       ...
       baocao1 = XuatReportUtil.ReportUtil(this.jasperPrintDT, this.index, IConstantsRes.PATH_BASE + IConstantsRes.PATH_REPORT_RESULT_DIEU_TRI + "hsba/", "pdf", "BieuMauBanTuDong3");
 ...
 * Qualified Name:     com.iesvn.yte.dieutri.hsba.action.B297_BieuMauBanTuDong3
