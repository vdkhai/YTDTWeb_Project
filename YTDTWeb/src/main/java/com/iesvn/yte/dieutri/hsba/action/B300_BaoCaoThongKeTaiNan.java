 ...
 public class B300_BaoCaoThongKeTaiNan
   implements Serializable
 {
   ...
   {
     this.loaiBCDT = "BaoCaoThongKeTaiNan";
     ...
     try
     {
       ...
       if (this.tieude.trim().equals(""))
       {
         if ("1".equals(this.loaiBaoCao.trim())) {
           ...
           params.put("tieude", IConstantsRes.BAO_CAO_THONG_KE + " " + this.thoigian + " " + IConstantsRes.THANG_NAM + " " + this.nam);
         }
       }
       else {
 ...
 * Qualified Name:     com.iesvn.yte.dieutri.hsba.action.B300_BaoCaoThongKeTaiNan
