 ...
 public class CapNhatThongTinChiTietBARhmAction
   implements Serializable
 {
   private static final long serialVersionUID = 10L;
   private static transient Logger log = Logger.getLogger(CapNhatThongTinChiTietBARhmAction.class);
   @Out(required=false)
   @In(required=false)
     ...
     throws Exception
   {
     ...
     if (this.hsbaChuyenMon != null)
     {
       if (this.hsbaChuyenMon.getHsbaSovaovien() != null)
       {
         ...
         try
         {
           hsbaCTRhmTemp = HsbaChiTietRhmDelegate.getInstance().findByHsbaCM(this.hsbaChuyenMon.getHsbacmMa());
         }
         catch (Exception e)
         {
           log.info("error:" + e);
         ...
         if (hsbaCTRhmTemp != null) {
           this.hsbaCTRhm = hsbaCTRhmTemp;
         } else {
           this.hsbaCTRhm = new HsbaChiTietRhm();
         }
       }
       else
       {
   ...
   public void ghinhan()
   {
     ...
     this.hsbaCTRhm.setHsbacmMa(this.hsbaChuyenMon);
     RemoveUtil.removeAllNullFromHSBACTRhm(this.hsbaCTRhm);
     if (this.hsbaCTRhm.getHsbactrhmMa() == null) {
       HsbaChiTietRhmDelegate.getInstance().create(this.hsbaCTRhm);
     } else {
       HsbaChiTietRhmDelegate.getInstance().edit(this.hsbaCTRhm);
     }
   ...
   {
     this.loaiBCDT = "CapNhatThongTinChiTietBARhm";
     ...
     try
     {
       ...
       if (this.hsbaCTRhm.getHsbactrhmCoquankhac() != null) {
         sBenhcoquankhac = this.hsbaCTRhm.getHsbactrhmCoquankhac();
       }
       params.put("BENHCOQUANKHAC", sBenhcoquankhac);

       String sChitietbenhcoquankhac = "";
       if (this.hsbaCTRhm.getHsbactrhmChitietbenhcoquankhac() != null) {
         sChitietbenhcoquankhac = this.hsbaCTRhm.getHsbactrhmChitietbenhcoquankhac();
       }
       params.put("CHITIETBENHCOQUANKHAC", sChitietbenhcoquankhac);
       if (this.hsbaCTRhm.getHsbactrhmLydovaov() != null) {
         params.put("LYDOVAOVIEN", this.hsbaCTRhm.getHsbactrhmLydovaov());
       }
       if (this.hsbaCTRhm.getHsbactrhmNgaybenhthu() != null) {
         params.put("VAONGAYTHU", this.hsbaCTRhm.getHsbactrhmNgaybenhthu());
       }
       if (this.hsbaCTRhm.getHsbactrhmQtbenhly() != null) {
         params.put("QTBENHLY", this.hsbaCTRhm.getHsbactrhmQtbenhly());
       }
       if (this.hsbaCTRhm.getHsbactrhmTiensubenhbt() != null) {
         params.put("TSBBANTHAN", this.hsbaCTRhm.getHsbactrhmTiensubenhbt());
       }
       if (this.hsbaCTRhm.getHsbactrhmTiensubenhgd() != null) {
         params.put("GIADINH", this.hsbaCTRhm.getHsbactrhmTiensubenhgd());
       }
       if ((this.hsbaCTRhm.getHsbactrhmDdDiung() != null) && (this.hsbaCTRhm.getHsbactrhmDdDiung().booleanValue() == true)) {
         params.put("DIUNG", "1");
       } else {
         params.put("DIUNG", "2");
       }
       if ((this.hsbaCTRhm.getHsbactrhmDdMatuy() != null) && (this.hsbaCTRhm.getHsbactrhmDdMatuy().booleanValue() == true)) {
         params.put("MATUY", "1");
       } else {
         params.put("MATUY", "2");
       }
       if ((this.hsbaCTRhm.getHsbactrhmDdRuoubia() != null) && (this.hsbaCTRhm.getHsbactrhmDdRuoubia().booleanValue() == true)) {
         params.put("RUOUBIA", "1");
       } else {
         params.put("RUOUBIA", "2");
       }
       if ((this.hsbaCTRhm.getHsbactrhmDdThuocla() != null) && (this.hsbaCTRhm.getHsbactrhmDdThuocla().booleanValue() == true)) {
         params.put("THUOCLA", "1");
       } else {
         params.put("THUOCLA", "2");
       }
       if ((this.hsbaCTRhm.getHsbactrhmDdThuoclao() != null) && (this.hsbaCTRhm.getHsbactrhmDdThuoclao().booleanValue() == true)) {
         params.put("THUOCLAO", "1");
       } else {
         params.put("THUOCLAO", "2");
       }
       if ((this.hsbaCTRhm.getHsbactrhmDdKhac() != null) && (this.hsbaCTRhm.getHsbactrhmDdKhac().booleanValue() == true)) {
         params.put("KHAC", "1");
       } else {
         params.put("KHAC", "2");
       }
       if (this.hsbaCTRhm.getHsbactrhmDdDiungTg() != null) {
         params.put("DIUNGTG", this.hsbaCTRhm.getHsbactrhmDdDiungTg());
       }
       if (this.hsbaCTRhm.getHsbactrhmDdMatuyTg() != null) {
         params.put("MATUYTG", this.hsbaCTRhm.getHsbactrhmDdMatuyTg());
       }
       if (this.hsbaCTRhm.getHsbactrhmDdRuoubiaTg() != null) {
         params.put("RUOUBIATG", this.hsbaCTRhm.getHsbactrhmDdRuoubiaTg());
       }
       if (this.hsbaCTRhm.getHsbactrhmDdThuoclaTg() != null) {
         params.put("THUOCLATG", this.hsbaCTRhm.getHsbactrhmDdThuoclaTg());
       }
       if (this.hsbaCTRhm.getHsbactrhmDdThuoclaoTg() != null) {
         params.put("THUOCLAOTG", this.hsbaCTRhm.getHsbactrhmDdThuoclaoTg());
       }
       if (this.hsbaCTRhm.getHsbactrhmDdKhacTg() != null) {
         params.put("KHACTG", this.hsbaCTRhm.getHsbactrhmDdKhacTg());
       }
       if (this.hsbaCTRhm.getHsbactrhmToanthan() != null) {
         params.put("TOANTHAN", this.hsbaCTRhm.getHsbactrhmToanthan());
       }
       if (this.hsbaCTRhm.getHsbactrhmThantietnieusinhhoc() != null) {
         params.put("THANTNSD", this.hsbaCTRhm.getHsbactrhmThantietnieusinhhoc());
       }
       if (this.hsbaCTRhm.getHsbactrhmTuanhoan() != null) {
         params.put("TUANHOAN", this.hsbaCTRhm.getHsbactrhmTuanhoan());
       }
       if (this.hsbaCTRhm.getHsbactrhmHohap() != null) {
         params.put("HOHAP", this.hsbaCTRhm.getHsbactrhmHohap());
       }
       if (this.hsbaCTRhm.getHsbactrhmTieuhoa() != null) {
         params.put("TIEUHOA", this.hsbaCTRhm.getHsbactrhmTieuhoa());
       }
       if (this.hsbaCTRhm.getHsbactrhmThankinh() != null) {
         params.put("THANKINH", this.hsbaCTRhm.getHsbactrhmThankinh());
       }
       if (this.hsbaCTRhm.getHsbactrhmCoxuongkhop() != null) {
         params.put("COXUONGKHOP", this.hsbaCTRhm.getHsbactrhmCoxuongkhop());
       }
       if (this.hsbaCTRhm.getHsbactrhmTmh() != null) {
         params.put("TMH", this.hsbaCTRhm.getHsbactrhmTmh());
       }
       if (this.hsbaCTRhm.getHsbactrhmMat() != null) {
         params.put("RHM", this.hsbaCTRhm.getHsbactrhmMat());
       }
       if (this.hsbaCTRhm.getHsbactrhmBslamba() != null) {
         params.put("BASILAMBA", this.hsbaCTRhm.getHsbactrhmBslamba(true).getDtdmnhanvienTen());
       }
       String sNguoigiaoBa = "";
       String sNguoinhanBa = "";
       if (this.hsbaCTRhm.getHsbactrhmNguoigiaoba() != null) {
         sNguoigiaoBa = this.hsbaCTRhm.getHsbactrhmNguoigiaoba(true).getDtdmnhanvienTen();
       }
       if (this.hsbaCTRhm.getHsbactrhmNguoinhanba() != null) {
         sNguoinhanBa = this.hsbaCTRhm.getHsbactrhmNguoinhanba(true).getDtdmnhanvienTen();
       }
       params.put("NGUOIGIAOBA", sNguoigiaoBa);
       params.put("NGUOINHANBA", sNguoinhanBa);
       if (this.hsbaCTRhm.getHsbactrhmNtDdBlk() != null) {
         params.put("NTDDBLK", this.hsbaCTRhm.getHsbactrhmNtDdBlk());
       }
       if (this.hsbaCTRhm.getHsbactrhmTtba() != null) {
         params.put("TTBA", this.hsbaCTRhm.getHsbactrhmTtba());
       }
       if (this.hsbaChuyenMon.getHsbacmHuongdieutri() != null) {
         params.put("HUONGDT", this.hsbaChuyenMon.getHsbacmHuongdieutri());
       }
       if (this.hsbaCTRhm.getHsbactrhmQtblDbls() != null) {
         params.put("QTBLDBLS", this.hsbaCTRhm.getHsbactrhmTtba());
       }
       if (this.hsbaCTRhm.getHsbactrhmTtkqxncls() != null) {
         params.put("TTKQCLSCD", this.hsbaCTRhm.getHsbactrhmTtkqxncls());
       }
       if (this.hsbaCTRhm.getHsbactrhmPpdieutri() != null) {
         params.put("PPDT", this.hsbaCTRhm.getHsbactrhmPpdieutri());
       }
       if (this.hsbaCTRhm.getHsbactrhmTtnguoibenhrav() != null) {
         params.put("TTNBRV", this.hsbaCTRhm.getHsbactrhmTtnguoibenhrav());
       }
       if (this.hsbaCTRhm.getHsbactrhmHuongdtCdtt() != null) {
         params.put("HDTCCDTT", this.hsbaCTRhm.getHsbactrhmHuongdtCdtt());
       }
       if (this.hsbaCTRhm.getHsbactrhmSotoxquang() != null) {
         params.put("XQUANG", this.hsbaCTRhm.getHsbactrhmSotoxquang());
       }
       if (this.hsbaCTRhm.getHsbactrhmSotoctscanner() != null) {
         params.put("SCANNER", this.hsbaCTRhm.getHsbactrhmSotoctscanner());
       }
       if (this.hsbaCTRhm.getHsbactrhmSotosieuam() != null) {
         params.put("SIEUAM", this.hsbaCTRhm.getHsbactrhmSotosieuam());
       }
       if (this.hsbaCTRhm.getHsbactrhmSotoxn() != null) {
         params.put("XETNGHIEM", this.hsbaCTRhm.getHsbactrhmSotoxn());
       }
       if (this.hsbaCTRhm.getHsbactrhmSotokhac() != null) {
         params.put("HSKHAC", this.hsbaCTRhm.getHsbactrhmSotokhac());
       }
       if (this.hsbaCTRhm.getHsbactrhmTongsoto() != null) {
         params.put("TONGHOSO", this.hsbaCTRhm.getHsbactrhmTongsoto());
       }
       if (this.hsbaCTRhm.getHsbactrhmNguoigiaoba() != null) {
         params.put("NGUOIGIAOHS", this.hsbaCTRhm.getHsbactrhmNguoigiaoba(true).getDtdmnhanvienTen());
       }
       if (this.hsbaCTRhm.getHsbactrhmNguoinhanba() != null) {
         params.put("NGUOINHANHS", this.hsbaCTRhm.getHsbactrhmNguoinhanba(true).getDtdmnhanvienTen());
       }
       if (this.hsbaCTRhm.getHsbactrhmBsdieutri() != null) {
         params.put("BASIDT", this.hsbaCTRhm.getHsbactrhmBsdieutri(true).getDtdmnhanvienTen());
       }
       ...
       if (this.hsbaCTRhm.getHsbactrhmTienluong() != null) {
         params.put("TIENLUONG", this.hsbaCTRhm.getHsbactrhmTienluong());
       }
       String sBSLAMBA = "";
       if (this.hsbaCTRhm.getHsbactrhmBslamba() != null) {
         sBSLAMBA = this.hsbaCTRhm.getHsbactrhmBslamba(true).getDtdmnhanvienTen();
       }
       ...
       baocao1 = XuatReportUtil.ReportUtil(this.jasperPrintDT, this.index, IConstantsRes.PATH_BASE + IConstantsRes.PATH_REPORT_RESULT_DIEU_TRI + "hsba/", "pdf", "CapNhatThongTinChiTietBARhm");
 ...
 * Qualified Name:     com.iesvn.yte.dieutri.hsba.action.CapNhatThongTinChiTietBARhmAction
