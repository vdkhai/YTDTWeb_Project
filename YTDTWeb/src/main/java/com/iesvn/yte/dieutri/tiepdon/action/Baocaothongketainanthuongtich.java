 ...
 public class Baocaothongketainanthuongtich
   implements Serializable
 {
   ...
   {
     this.reportTypeTD = "Baocaothongketainanthuongtich";
     this.log.info("Vao Method XuatReport bao cao tai nan thuong tich", new Object[0]);
     String baocao1 = null;
     try
     {
       ...
       baocao1 = XuatReportUtil.ReportUtil(this.jasperPrintTD, this.index, IConstantsRes.PATH_BASE + IConstantsRes.PATH_REPORT_RESULT_DIEU_TRI + "tiepdon/", "pdf", "Baocaothongketainanthuongtich");
 ...
 * Qualified Name:     com.iesvn.yte.dieutri.tiepdon.action.Baocaothongketainanthuongtich
