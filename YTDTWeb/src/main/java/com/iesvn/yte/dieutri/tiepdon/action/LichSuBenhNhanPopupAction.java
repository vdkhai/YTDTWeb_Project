 ...
 public class LichSuBenhNhanPopupAction
   implements Serializable
 {
   ...
   {
     return this.listFordanhsachlichsubenhnhan;
   }
   ...
   {
     log.info("---init");
     this.listFordanhsachlichsubenhnhan = new ArrayList();
   }
     ...
     if (((this.result != null ? 1 : 0) & (!this.result.equals("") ? 1 : 0)) != 0)
     {
       ...
       try
       {
         ...
         for (int i = 0; i < arr.length(); i++)
         {
           ...
           this.listFordanhsachlichsubenhnhan.add(item);
         }
       }
       catch (Exception e) {}
     }
 ...
 * Qualified Name:     com.iesvn.yte.dieutri.tiepdon.action.LichSuBenhNhanPopupAction
