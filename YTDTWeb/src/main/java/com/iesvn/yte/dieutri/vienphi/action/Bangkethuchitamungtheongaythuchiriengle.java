 ...
 public class Bangkethuchitamungtheongaythuchiriengle
   implements Serializable
 {
   ...
   {
     XuatReport();
     this.resetFormB3311Thuchiriengle = null;
     return "B3360_Chonmenuxuattaptin";
   }

   public void resetForm()
   {
     this.resetFormB3311Thuchiriengle = "";
 ...
 * Qualified Name:     com.iesvn.yte.dieutri.vienphi.action.Bangkethuchitamungtheongaythuchiriengle
