 ...
 public class BaocaoBHYTCLSngoaitru
   implements Serializable
 {
   ...
   {
     this.reportTypeVP = "BaocaoBHYTCLSngoaitru";
     this.log.info("Vao Method XuatReport bao cao BHYT CLS ngoai tru", new Object[0]);
     String baocao1 = null;
     ...
     try
     {
       ...
       baocao1 = XuatReportUtil.ReportUtil(this.jasperPrintVP, this.index, IConstantsRes.PATH_BASE + IConstantsRes.PATH_REPORT_RESULT_DIEU_TRI + "vienphi/", "pdf", "BaocaoBHYTCLSngoaitru");
 ...
 * Qualified Name:     com.iesvn.yte.dieutri.vienphi.action.BaocaoBHYTCLSngoaitru
