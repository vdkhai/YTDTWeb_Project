 ...
 public class PhieuDTLanhThuocTuTrucNGTAction
   implements Serializable
 {
   ...
   @DataModel
   private ArrayList<CtPhieuDuTruExt> listCtDTLanhThuocNGTEx;
   ...
   public void createTable()
   {
     ...
     this.listCtDTLanhThuocNGTEx = new ArrayList();
   }
   ...
   public void refreshDmThuoc()
   {
     ...
     if ((!loaiMa.equals("")) && (!this.phieuDuTru.getPhieudtLoaiPhieu().equals("")) && (this.phieuDuTru.getPhieudtMakho(true).getDmkhoaMaso() != null)) {
       lstDmThuoc = this.dmThuocDelegate.findByLoaiPhanLoaiThuocNhomThuocDVTKho(loaiMa, phanloaiMa, this.phieuDuTru.getPhieudtMakho(true).getDmkhoaMaso());
     }
   ...
   public void onblurMaKhoXuatAction()
   {
     ...
     if (this.dmkhoaXuatMa != "")
     {
       ...
       if (dmKhoa != null)
       {
         ...
         setDmkhoaXuatMa(this.dmkhoaXuatMa.toUpperCase());
   ...
   public void onblurLoaiPhieuAction()
   {
     ...
     if ((this.maPhieu == null) || (this.maPhieu.equals(""))) {
       this.listCtDTLanhThuocNGTEx.clear();
     }
   ...
   {
     log.info("-----deleteCt()-----");
     CtPhieuDuTruExt ctExDel = (CtPhieuDuTruExt)this.listCtDTLanhThuocNGTEx.remove(index);
     this.listCtPhieuDtDel.add(ctExDel.getCtPhieuDt());
     this.count = Integer.valueOf(this.listCtDTLanhThuocNGTEx.size());
     tinhTien();
   }
   ...
   public void selectCt(Integer index)
   {
     ...
     try
     {
       this.selected = ((CtPhieuDuTruExt)this.listCtDTLanhThuocNGTEx.get(index.intValue()));
       this.listMas = this.selected.getListThuocPhongKhamMa();
   ...
   public void tiepTucNhap()
   {
     ...
     else
     {
       ...
       if (this.updateItem.intValue() != -1) {
         if (this.listCtDTLanhThuocNGTEx.size() > this.updateItem.intValue())
         {
       ...
       if (tk != null)
       {
         ...
         if (this.listCtDTLanhThuocNGTEx.size() > 0)
         {
           for (int i = 0; i < this.listCtDTLanhThuocNGTEx.size(); i++)
           {
             CtPhieuDuTruExt ctPhieuDuTruExt = (CtPhieuDuTruExt)this.listCtDTLanhThuocNGTEx.get(i);
         ...
         if (viTri == -1)
         {
           ...
           if (this.listCtDTLanhThuocNGTEx.size() > 0)
           {
             ...
             if (!foundOnNewsList)
             {
               ...
               this.listCtDTLanhThuocNGTEx.add(ctxEx);
             }
             else
             {
               ctx.setCtdtSoluong(Double.valueOf(sl));
               ctxEx = createCtDTru(ctx, tk);
               this.listCtDTLanhThuocNGTEx.set(vt, ctxEx);
             }
           }
           else
           {
         ...
         else
         {
           ...
           this.selected = ((CtPhieuDuTruExt)this.listCtDTLanhThuocNGTEx.get(viTri));
           ...
           this.listCtDTLanhThuocNGTEx.set(viTri, ctxEx);
         }
       }
       this.count = Integer.valueOf(this.listCtDTLanhThuocNGTEx.size());
       log.info(String.format("-----listCtXuatKho: %s", new Object[] { Integer.valueOf(this.listCtDTLanhThuocNGTEx.size()) }));
       this.tonkhoMa = "";
       this.dmtMa = "";
       this.dmtTen = "";
       this.tonkho = new Double(0.0D);
   ...
   public List<ThuocPhongKham> getThuocPhongKham()
   {
     ...
     if ((loaiPhieu != null) || (!loaiPhieu.equals(""))) {
       if (this.phieuDuTru.getDmloaithuocMaso(true).getDmloaithuocMa() != null) {
         if (this.phieuDuTru.getDmloaithuocMaso(true).getDmloaithuocMa().toUpperCase().equals("TD"))
         {
           System.out.println("dmLoaiPhieuMa: " + this.dmLoaiPhieuMa);
           if ((!this.dmLoaiPhieuMa.equals("HT")) && (!this.dmLoaiPhieuMa.equals("GN")))
           {
             loaiMa = "TD-TT";
             DmLoaiPhieu lp = (DmLoaiPhieu)this.hmDmLoaiPhieu.get(this.dmLoaiPhieuMa);
   ...
   public void end()
   {
     ...
     if (this.listCtDTLanhThuocNGTEx.size() > 0)
     {
       ...
       try
       {
         ...
         List<Integer> listThuocPhongKhamMa = new ArrayList();
         HashMap<Integer, List> ctdt_matpk = new HashMap();
         CtPhieuDuTruExt obj = new CtPhieuDuTruExt();
         for (int i = 0; i < this.listCtDTLanhThuocNGTEx.size(); i++)
         {
           CtPhieuDt ct = ((CtPhieuDuTruExt)this.listCtDTLanhThuocNGTEx.get(i)).getCtPhieuDt();
           List<Integer> listThuocPhongKhamMa_Temp = ((CtPhieuDuTruExt)this.listCtDTLanhThuocNGTEx.get(i)).getListThuocPhongKhamMa();
           ...
           ctdt_matpk.put(Integer.valueOf(i), listThuocPhongKhamMa_Temp);
         ...
         clearInfor();
         String ketqua = pxDelegate.updatePhieuDuTruLinhNGT(this.phieuDuTru, listCtPhieuDt, this.listCtPhieuDtDel, listThuocPhongKhamMa, ctdt_matpk, IConstantsRes.PRIORITY_TON_LO_THUOC);
         if ((ketqua != null) && (ketqua != ""))
         {
           ...
           {
             resetInfo();
             FacesMessages.instance().add(IConstantsRes.PHIEUXUATKHO_THANHCONG, new Object[] { ketqua });
             this.maPhieu = ketqua;
             displayPhieuXuatKho();
     ...
     if ((this.phieuDuTru.getPhieudtMa() == null) || (this.phieuDuTru.getPhieudtMa().equals(""))) {
       try
       {
         ...
         if (tpk_temp != null)
         {
           ...
           List<Integer> tpkMaList = new ArrayList();
           for (ThuocPhongKham tpk : tpk_temp)
           {
             ctPhieuDt = new CtPhieuDt();
             tpkMaList = new ArrayList();
             ...
             else
             {
               ...
               if (foundInList == true)
               {
                 ...
                 ctPhieuDt.setCtdtSoluong(Double.valueOf(ctPhieuDt.getCtdtSoluong().doubleValue() + tpk.getThuocphongkhamSoluong().doubleValue()));
                 tpkMaList = resultListExt.getListThuocPhongKhamMa();
                 tpkMaList.add(tpk.getThuocphongkhamMa());
           ...
           if (listCtDTEx_Temp.size() > 0) {
             ...
             {
               this.listCtDTLanhThuocNGTEx.add(ctPhieuDuTruExt);
               System.out.println("List tpk: " + ctPhieuDuTruExt.getListThuocPhongKhamMa());
             }
           }
           tinhTien();
   ...
   public PhieuDTLanhThuocTuTrucNGTAction()
   {
     this.listCtDTLanhThuocNGTEx = new ArrayList();
   ...
   {
     this.reportTypeVP = "PhieuLanhThuocTuTrucKhoaPhongNGT";
   ...
   {
     this.tongTien = new Double("0");
     for (CtPhieuDuTruExt ctExt : this.listCtDTLanhThuocNGTEx)
     {
     ...
     implements Serializable
   {
     ...
     public CtPhieuDuTruExt()
     {
       ...
       this.listThuocPhongKhamMa = new ArrayList();
     ...
     {
       return this.listThuocPhongKhamMa;
     }
 ...
 * Qualified Name:     com.iesvn.yte.dieutri.vienphi.action.PhieuDTLanhThuocTuTrucNGTAction
