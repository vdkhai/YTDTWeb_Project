 ...
 public class Solieuthuchicackhoa
   implements Serializable
 {
   ...
   {
     this.reportTypeVP = "Solieuthuchicackhoa";
     this.log.info("Vao Method XuatReport So lieu thu chi cac khoa", new Object[0]);
     String baocao1 = null;
     ...
     try
     {
       ...
       baocao1 = XuatReportUtil.ReportUtil(this.jasperPrintVP, index, IConstantsRes.PATH_BASE + IConstantsRes.PATH_REPORT_RESULT_DIEU_TRI + "vienphi/", "pdf", "Solieuthuchicackhoa");
 ...
 * Qualified Name:     com.iesvn.yte.dieutri.vienphi.action.Solieuthuchicackhoa
