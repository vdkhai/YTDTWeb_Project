 ...
 public class UpdatingThuocAutoServlet
   extends HttpServlet
 {
     ...
     throws ServletException
   {
     ...
     try
     {
       ...
       if ((startOnLoad == null) || (Boolean.getBoolean(startOnLoad)))
       {
         ...
         JobDetail job = JobBuilder.newJob(UpdatingThuocJob.class).withIdentity("UpdatingThuocJob", "UPDATINGTHUOC_GROUP").storeDurably().requestRecovery().build();
         ...
         CronTrigger trigger = (CronTrigger)TriggerBuilder.newTrigger().withIdentity("UpdatingThuocTrigger", "UPDATINGTHUOC_GROUP").withSchedule(CronScheduleBuilder.cronSchedule(cronExpr)).build();
 ...
 * Qualified Name:     com.iesvn.yte.job.UpdatingThuocAutoServlet
