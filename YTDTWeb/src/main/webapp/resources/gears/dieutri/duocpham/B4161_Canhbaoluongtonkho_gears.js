...
{
	var soluongmax = document.getElementById(prefix_component + "__soluongmax").value;
	var soluongmin =document.getElementById(prefix_component + "__soluongmin").value;
	if(soluongmax!=null && soluongmax!="" && soluongmin!=null && soluongmin!="")
	{
		var sl1 = parseFloat(soluongmax);
		var sl2 = parseFloat(soluongmin);
		if(sl1 < sl2)
			{
				alert("Số lượng đến phải nhỏ hơn số lượng từ");
				return false;
			}
