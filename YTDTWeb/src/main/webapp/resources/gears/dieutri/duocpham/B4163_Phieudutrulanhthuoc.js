function init() {
	...
	if (window.google && google.gears) {
		//try {
            ...
            setAttrForCombobox(prefix_component + "DM_KINH_PHI_MASO","DM_KINH_PHI_span", "DM_NGUON_KINH_PHI", "getDmNguonKinhPhi()", "clearDmt()", "", "");
            setAttrForCombobox(prefix_component + "DT_DM_NGUON_MA", "DT_DM_NGUON_span", "DM_NGUON_CHUONG_TRINH", "getDmNguonChuongTrinh()", "clearDmt()", "", "");
			...
			setAttrForCombobox(prefix_component + "DM_KHOA_NHAN","DM_KHO_span1","DM_KHOA__1","getDmKhoa_Ct(\""+ document.getElementById(prefix_component + "DM_KHO_NHAN").value +"\")","","","");
         	...
         	//setAttrForCombobox(prefix_component + 'DT_DM_LOAI_MA','DT_DM_LOAI_span', 'DM_LOAI_THUOC', "getDmLoaiThuoc()", "clearDmt()", "", "");
...
function setValueOnLoad(){
	...
	try {
		...
		if (kc_value == 'KC'){
			...
			document.getElementById(prefix_component + "DM_KHOA_NHAN").value = "KTE";
		}
