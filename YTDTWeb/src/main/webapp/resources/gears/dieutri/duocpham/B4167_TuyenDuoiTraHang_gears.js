function init() {
    ...
    if (window.google && google.gears) {
        try {
			...
			setAttrForCombobox(prefix_component + "DM_KHOA_MA_1","DM_KHOA__1_span","DM_KHOA__1","getDmKhoa_Ct(\""+ document.getElementById(prefix_component + "DM_KHO_NHAN").value +"\")","","","");
...
function getTonkho() {
  try{
	...
	var khoaTra = document.getElementById(prefix_component + "DM_KHOA_MA_2").value;
	/*
	if (maHang == ""){
	  document.getElementById(prefix_component + "__maso").focus();
	  return;
	...
	*/
	...
	var request = maHang + " ;" + kinhphiMa + " ;" + nguonMa + " ;" + khoaTra + " ; ";
