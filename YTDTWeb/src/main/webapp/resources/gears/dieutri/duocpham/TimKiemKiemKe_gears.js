function init() {
    ...
    if (window.google && google.gears) {
        ...
        try {
				setAttrForCombobox(prefix_component + "LOAIPHIEU_MA","DM_LOAI_THUOC_span","DM_LOAI_THUOC","getDmLoaiThuoc()","","document.getElementById(prefix_component + 'PHANLOAI_MA').focus()","");
