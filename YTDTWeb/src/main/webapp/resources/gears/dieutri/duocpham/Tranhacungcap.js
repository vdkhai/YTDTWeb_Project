function init() {
	...
	if (window.google && google.gears) {
            ...
            setAttrForCombobox(prefix_component + "DM_NHA_CUNG_CAP_MA", "DT_DM_NGUON_span", "DM_NHA_CUNG_CAP", "getDmNhaCungCap()", "clearDetail()", "", "");
                  
            //alert(tenCt);
            
            setAttrForCombobox(prefix_component + "DM_KHOA_XUAT","DM_KHO_span2","DM_KHOA__2","getDmKhoa_KhoChinh()","","","");
			document.getElementById(prefix_component + "DM_KHOA_XUAT").value = "KCH";
           	myOnblurTextbox(prefix_component + "DM_KHOA_XUAT", "DM_KHOA__2");
           	document.getElementById(prefix_component + "DM_KHOA_XUAT").disabled = true;
...
function resetTonInfo(){
	...
	document.getElementById(prefix_component + "__malk").value ="";
...
function setValueOnLoad(){
		myOnblurTextbox(prefix_component + "DM_NHA_CUNG_CAP_MA", "DM_NHA_CUNG_CAP");
		myOnblurTextbox(prefix_component + "DM_KHOA_XUAT", "DM_KHOA__2");
