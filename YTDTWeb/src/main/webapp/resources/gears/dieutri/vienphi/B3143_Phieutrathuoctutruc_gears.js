function init() {
	...
	if (window.google && google.gears) {
		//try {
            ...
            setAttrForCombobox(prefix_component + "DM_KHOA_NHAN","DM_KHO_span1","DM_KHOA__1","getDmKhoa_KhoChinh_KhoLe_BHYT_TE()","","","");
			
            setAttrForCombobox(prefix_component + 'DT_DM_NHAN_VIEN_BASI','DT_DM_NHAN_VIEN_span3', 'DT_DM_NHAN_VIEN__2', "getDtDmNhanVienByMaKhoa(\"" + prefix_component + "DM_KHOA_XUAT\")", "", "", "");
          	setAttrForCombobox(prefix_component + 'DT_DM_NHAN_VIEN_CN','DT_DM_NHAN_VIEN_span3', 'DT_DM_NHAN_VIEN__3', "getDtDmNhanVienByMaKhoa(\"" + prefix_component + "DM_KHOA_XUAT\")", "", "", "");
            
            //@Trung
		    setAttrForCombobox(prefix_component + "DT_DM_NHAN_VIEN_MA_2","DT_DM_NHAN_VIEN_span2","DT_DM_NHAN_VIEN__4","getDtDmNhanVienByMaKhoa(\"" + prefix_component + "DM_KHOA_XUAT\")","","","");
...
function clearDmt() {
	//document.getElementById(prefix_component + "DM_THUOC_MASO").value = "";
	//myOnblurTextboxForDmThuoc(prefix_component + "DM_THUOC_MASO", 'DM_THUOC', document.getElementById(prefix_component + 'DT_DM_LOAI_MA').value,'');
	document.getElementById(prefix_component + "__tonkho").value = "";
	document.getElementById("__listtonkho_duocpham").value = "";
	document.getElementById(prefix_component + "__tonkhoma_hid").value = "";
